...
public interface IDownloadManager
{
    ...
    StreamQueryInfo SelectStreams(StreamManifest streams, bool downloadVideo = true, bool downloadAudio = true,
    ...
    // /// <param name="destination">The destination path where to save the downloaded file. Must exclude file extension.</param>
    // /// <param name="downloadVideo">Whether to download the video.</param>
    // /// <param name="downloadAudio">Whether to download the audio.</param>
    // /// <param name="options">The download options.</param>
    ...
    // /// <exception cref="TaskCanceledException">Download was cancelled or timed out.</exception>
    // /// <exception cref="UriFormatException">The Url is invalid.</exception>
    // Task<DownloadStatus> DownloadAsync(string downloadUrl, string destination, bool downloadVideo = true, bool downloadAudio = true,
    //     DownloadOptions? options = null, DownloadTaskEventHandler? taskCreatedCallback = null);
    //
    // /// <summary>
    // /// Starts a new download task and adds it to the downloads pool.
    // /// </summary>
    ...
    // /// <exception cref="TaskCanceledException">Download was cancelled or timed out.</exception>
    // /// <exception cref="UriFormatException">The Url is invalid.</exception>
    // Task<DownloadStatus> DownloadAsync(Uri downloadUrl, string destination, bool downloadVideo = true, bool downloadAudio = true,
    //     DownloadOptions? options = null, DownloadTaskEventHandler? taskCreatedCallback = null);
    ...
    /// <param name="destination">The destination path where to save the downloaded file.</param>
    /// <param name="taskCreatedCallback">Callback to receive an instance of the download task.</param>
    /// <exception cref="HttpRequestException">There was an error while processing the request.</exception>
    /// <exception cref="TaskCanceledException">Download was cancelled or timed out.</exception>
    /// <exception cref="UriFormatException">The Url is invalid.</exception>
    Task<DownloadStatus> DownloadAsync(StreamQueryInfo streamQuery, string destination,
