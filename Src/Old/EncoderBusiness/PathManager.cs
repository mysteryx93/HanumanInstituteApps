...
namespace EmergenceGuardian.MediaEncoder {
    public static class PathManager {
        public static string TempFilesPath  = Path.Combine(Path.GetPathRoot(Environment.SystemDirectory), "MediaEncoderTemp\\");
        public static string MPlayerPath = "MPlayer.exe";
