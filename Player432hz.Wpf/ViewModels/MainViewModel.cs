...
namespace HanumanInstitute.Player432hz.ViewModels
{
    ...
    public class MainViewModel : ReactiveObject
    {
        ...
        /// </summary>
        public ICommand AddPlaylistCommand => _addPlaylistCommand ??= new RelayCommand(OnAddPlaylist, CanAddPlaylist);
        private RelayCommand? _addPlaylistCommand;
        private bool CanAddPlaylist() => true;
        ...
        public ICommand DeletePlaylistCommand =>
            _deletePlaylistCommand ??= new RelayCommand(OnDeletePlaylist, CanDeletePlaylist);
