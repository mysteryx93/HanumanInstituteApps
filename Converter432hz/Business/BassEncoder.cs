...
/// <inheritdoc />
public class BassEncoder : IBassEncoder
{
    private readonly IFileSystemService _fileSystem;

    public BassEncoder(IFileSystemService fileSystem)
    {
    ...
    public void Start(ProcessingItem file, EncodeSettings settings, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            {
                EncodeFormat.Wav => BassEnc
                    .EncodeStart(chanMix, file.Destination, EncodeFlags.PCM | flags, null).Valid(),
