...
#pragma warning disable CA1062 // Validate arguments of public methods
        ...
        public static ScrollBar GetVerticalScrollBar(DependencyObject d) => (ScrollBar)d.GetValue(VerticalScrollBarProperty);
        public static void SetVerticalScrollBar(DependencyObject d, ScrollBar value) => d.SetValue(VerticalScrollBarProperty, value);
        ...
        public static readonly DependencyProperty HorizontalScrollBarProperty = DependencyProperty.RegisterAttached("HorizontalScrollBar", typeof(ScrollBar),
            typeof(ScrollViewerBinding), new PropertyMetadata(null));
        public static ScrollBar GetHorizontalScrollBar(DependencyObject d) => (ScrollBar)d.GetValue(HorizontalScrollBarProperty);
        public static void SetHorizontalScrollBar(DependencyObject d, ScrollBar value) => d.SetValue(HorizontalScrollBarProperty, value);
